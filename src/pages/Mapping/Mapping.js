...
function Mapping() {
  ...
  const onSubmitMapping = async (event) => {
    ...
    const response = await fetch("https://online-energy-utility-plat.herokuapp.com/api/admin/user-device/", {
      method: "POST",
      headers: {
  ...
  const fetchDataDevice = async () => {
    const response = await fetch("https://online-energy-utility-plat.herokuapp.com/api/admin/device/", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + sessionStorage.getItem("token"),
    ...
    const response2 = await fetch("https://online-energy-utility-plat.herokuapp.com/api/admin/user/", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + sessionStorage.getItem("token"),
